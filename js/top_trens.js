...
function fetching() {
    ...
    let url = "https://ap-south-1.aws.data.mongodb-api.com/app/api-smznw/endpoint/trending?secret=new";
    fetch(url)
        ...
        completeData +=
            ...
            <div class="col-md-6 d-flex align-items-center justify-content-center">
                <div class="card-body">
                    ...
                    <h4 class="card-title  text-center" style="color:#282c34;font-weight: bold; ">${val.category}</h4>
                    <p class="card-title  text-center" style="color:#282c34;font-weight: bold; ">${subCategory}</p>
